...
import ru.netology.repository.TicketByPriceAscComparator;
...
class TicketManagerTest {
    ...
    private TicketByPriceAscComparator time = new TicketByPriceAscComparator();

    Ticket ticket1 = new Ticket(1, 45000, "DMD", "KIX", 720);
    Ticket ticket2 = new Ticket(2, 40000, "DMD", "ONT", 780);
    Ticket ticket3 = new Ticket(3, 34000, "DMD", "KIX", 710);
    ...
    @Test
    void shouldSearchByFromToAndSortPriceAndTime() {
        Ticket ticket8 = new Ticket(8, 35000, "DMD", "KIX", 700);
        ...
        Ticket[] actual = manager.searchByFromToAndSortPriceAndTime("DMD", "KIX", time);
        Ticket[] expected = new Ticket[]{ticket8, ticket3, ticket1,ticket7};
        assertArrayEquals(expected, actual);
    }

    @Test
    void shouldSearchByFromToAndSortPriceAndTimeDouble() {
        Ticket ticket8 = new Ticket(8, 35000, "DMD", "KIX", 700);
        Ticket ticket9 = new Ticket(9, 35000, "DMD", "KIX", 700);
        ...
        Ticket[] actual = manager.searchByFromToAndSortPriceAndTime("DMD", "KIX", time);
        Ticket[] expected = new Ticket[]{ticket8, ticket9, ticket3, ticket1, ticket7};
        assertArrayEquals(expected, actual);
    }
}